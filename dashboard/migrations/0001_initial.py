    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_of_study', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='dashboard.community')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('featured_courses', models.ManyToManyField(to='dashboard.course')),
            ],
        ),
        migrations.CreateModel(
            name='Module',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('content_type', models.CharField(choices=[('pdf', 'PDF'), ('text', 'Text'), ('video', 'Video'), ('link', 'Link')], max_length=50)),
                ('url_or_file', models.FileField(blank=True, null=True, upload_to='modules/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_accessed_module', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dashboard.module')),
